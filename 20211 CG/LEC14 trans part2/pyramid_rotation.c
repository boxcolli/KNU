...
int main(int argc, char* argv[]) {
    ...
    glutAddMenuEntry("R by x-axis", MENU_X);
    glutAddMenuEntry("R by y-axis", MENU_Y);
    glutAddMenuEntry("R by z-axis", MENU_Z);
